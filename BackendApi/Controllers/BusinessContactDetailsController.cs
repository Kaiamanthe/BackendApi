...
namespace BackendApi.Controllers
{
    ...
    public class BusinessContactDetailsController : ControllerBase
    {
        ...
        public BusinessContactDetailsController(BackendApiContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != businessContactDetails.ContactID)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<BusinessContactDetails>> PostBusinessContactDetails(BusinessContactDetails businessContactDetails)
        {
            ...
            return CreatedAtAction("GetBusinessContactDetails", new { id = businessContactDetails.ContactID }, businessContactDetails);
        }
        ...
        {
            return _context.BusinessContactDetails.Any(e => e.ContactID == id);
        }
    }
}
